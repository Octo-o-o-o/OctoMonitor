...
export const handoffData = {
  ...
  settings: {
    ...
    monitor: [
      ...
      { label: 'Remote viewer', value: 'Read-only, cookie-paired, LAN/private-network ready' },
    ],
    filters: [
    ...
    server: [
      { label: 'Listen host', value: '127.0.0.1' },
      { label: 'Listen port', value: '46321' },
      { label: 'History retention', value: '14 days' },
      { label: 'Remote access', value: 'Managed in dedicated remote viewer section' },
    ],
    installer: [
